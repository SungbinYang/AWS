...
def lambda_handler(event, context):
    ...
    s3.Bucket(os.environ['BUCKET_NAME']).download_file('fonts/NotoSansKR-Bold.otf', '/tmp/font.otf')
    s3.Bucket(os.environ['BUCKET_NAME']).download_file('images/logo.en.png', '/tmp/logo.png')
